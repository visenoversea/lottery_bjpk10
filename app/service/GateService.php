...
class GateService
{
    ...
    private $url = 'https://api.gateio.ws';
    private $periodArr = ['1m', '5m', '15m', '30m', '1h', '4h', '1d', '7d', '30d'];
    /**
     * 不能被克隆
     */
...
//	}
    ...
    public static function getInstance(): ?GateService
    {
    ...
    public function get_history_kline($symbol = '', $period = 0, $size = 100)
    {
        ...
        //?currency_pair=BTC_USDT&limit=1&interval=1m
        $param = [
