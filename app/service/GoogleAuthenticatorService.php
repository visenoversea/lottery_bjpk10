...
class GoogleAuthenticatorService extends Redis
{
     ...
     * @return Redis|null
     */
    public static function getInstance(): ?GoogleAuthenticatorService
    {
     ...
     * @return string
     */
    public function getQRCodeData(string $name, string $secret, string $title = null): string
    {
     ...
     * @return bool
     */
    public function verifyCode(string $secret, $code, int $discrepancy = 1, int $currentTimeSlice = null): bool
    {
