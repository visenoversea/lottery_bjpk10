...
//            (WebSocketService::getInstance())->SendAdminTips('下注提示', '你有新的下注信息', 'getUserBetList2', 'UserBetItemList');
    ...
    public function history($limit = 20, $page = 1){
        ...
        $list = DB::table('user_bet_item as ubi')
            ...
            ->selectRaw("t_ub.open_expect,t_ubi.id,t_ubi.user_id,t_l.name,t_ubi.lottery_group_name,t_ubi.bet_no,t_ubi.bet_amount,t_ubi.bet_amount_mop,t_ubi.win_amount,t_ubi.win_amount_mop,t_ubi.odds,t_ubi.create_time,t_ub.status")
