...
let elementLocal = computed(() => {
  if(Object.prototype.hasOwnProperty.call(store.langObj,store.lang)) {
    return store.langObj[store.lang]
  }else {
    return store.langObj['en']
  }
})
